...
var Packager = (function () {
  function Packager (platform, environment) {
    ...
    this.version = require('../../package.json').versions['electron-prebuilt']
    this.platform = platform
    this.environment = (environment !== 'development' && environment !== 'production' ? 'development' : environment)
  ...
  Packager.prototype.productionBuild = function (platform, environment) {
    require('gulp-util').log('BOZON.productionBuild: ' + environment)
